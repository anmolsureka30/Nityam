...
def describe_gesture(packet: dict) -> str:
    ...
    if not quoted:
        if regions:
            ...
            return (
                ...
                f"words — so there is nothing quoted. Ask them what they meant "
                f"rather than guessing.]"
            )
        return (
            f"[The student used the {gesture} on a blank part of the page. Ask what "
            f"they were pointing at.]"
        )
