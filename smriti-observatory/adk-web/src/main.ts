...
import {MEMORY_SERVICE} from './app/core/services/interfaces/memory';
...
import {MemoryService} from './app/core/services/memory.service';
    ...
    .then((config) => {
      ...
      bootstrapApplication(AppComponent, {
        providers: [
          ...
          {provide: MEMORY_SERVICE, useClass: MemoryService},
          {
